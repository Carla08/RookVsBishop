...
@patch("rookvsbishop.games.rook_vs_bishop.random.choice", return_value="H")
@patch("rookvsbishop.games.rook_vs_bishop.random.randint", side_effect=[1, 1])
...
@patch("rookvsbishop.games.rook_vs_bishop.random.choice", return_value="H")
@patch("rookvsbishop.games.rook_vs_bishop.random.randint", side_effect=[3, 4])
...
@patch("rookvsbishop.games.rook_vs_bishop.random.choice", side_effect=["T"] * 3)
@patch("rookvsbishop.games.rook_vs_bishop.random.randint", side_effect=[1, 1] * 3)
